...
Además, agregamos 2 tipos de cuentas bancarias (cuenta de ahorro y cuenta corriente) y notificaciones a través de mail, aplicando los principios de Abierto-Cerrado y Sustitución de Liskov al crear los objetos.  
